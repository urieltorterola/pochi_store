            ...
            <section class="checkout-details">
                <h3>Detalles de la Dirección</h3>
                 <form class="registro-form">
                    ...
                    <input type="text" class="registro-input" value="Calle Ficticia #123, Ciudad" required>
                    <label class="registro-label">Código Postal</label>
                    <input type="text" class="registro-input" value="10000" required>
                    <label class="registro-label">Teléfono</label>
                    <input type="tel" class="registro-input" value="555-5555" required>
                </form>
            </section>
